...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto font-body relative">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                disabled={isPending}
                className="bg-accent text-white py-3 px-2 rounded-lg font-semibold text-xs border-0 cursor-pointer transition-all hover:opacity-90 disabled:opacity-50"
              >
                100 cr<br />(₹100)
              </button>
              <button
      ...
      {showSandbox && sandboxOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs" data-testid="sandbox-modal">
          <div className="bg-white border border-border rounded-2xl p-8 shadow-2xl max-w-md w-[90%] mx-auto animate-fade-in">
            ...
            <div className="bg-muted/30 border border-border rounded-xl p-4 mb-6 font-body text-sm space-y-2">
              <div className="flex justify-between">
                <span className="text-foreground/50">Receipt Code:</span>
                <span className="font-mono text-foreground">{sandboxOrder.orderId}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-foreground/50">Simulated Package:</span>
                <span className="font-semibold text-foreground">{sandboxOrder.credits} Credits</span>
              </div>
              <div className="flex justify-between border-t border-border pt-2 mt-2">
                <span className="text-foreground font-semibold">Total Price:</span>
                <span className="text-primary font-bold text-base">₹{sandboxOrder.amount}.00</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 font-body">
              <button
                ...
                className="w-full bg-accent text-white py-3 px-6 rounded-lg font-semibold text-sm border-0 cursor-pointer transition-all hover:opacity-90"
              >
              ...
              <button
                ...
                className="w-full bg-transparent text-foreground/70 py-2.5 px-6 rounded-lg font-semibold text-sm border border-border cursor-pointer transition-all hover:bg-muted/50"
              >
